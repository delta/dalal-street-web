            ...
            <div id="help-container" className="ui stackable grid pusher main-container">
                ...
                <div className="row">
                    ...
                    <div id="help-content" className="fourteen wide column">
                        <h2 className="ui header inverted">Welcome to Dalal Street! We know that there’s a lot to take in, so we’ve prepared this help page to get you started and to answer some FAQs as well.</h2>
                        <br />
                        <div id="help-tab" className="ui top attached tabular menu">
                            <a className="active item" data-tab="gettingstarted">Getting Started</a>
                            <a className="item" data-tab="faqs">FAQs</a>
                        </div>
                        <div className="ui bottom attached active tab segment" data-tab="gettingstarted">
                            ...
                            <h3 className="ui header inverted">The Objective</h3>
                            ...
                            <h3 className="ui header inverted">How do I make money?</h3>
                            ...
                            <p><em>If you’re unsure of what short selling means, check out our FAQs tab</em></p>
                            <h3 className="ui header inverted">The Basics</h3>
                            ...
                            <p className="image-wrapper"><img src="./public/src/images/help/Dalal_Market_Available.png" alt="Market Image" /></p>
                            ...
                            <h3 className="ui header inverted">Buying and Selling Stocks</h3>
                        ...
                        <div className="ui bottom attached tab segment" data-tab="faqs">
                            <h2 className="ui header inverted">FAQs</h2>

                            <h3 className="ui header inverted">What is this short selling you speak of?</h3>
                            ...
                            <h3 className="ui header inverted">What is my Net Worth and how is it calculated?</h3>
                            ...
                            <h3 className="ui header inverted">What is the difference between <em>Stocks in Market</em> and <em>Stocks in Exchange</em>?</h3>
                            ...
                            <h3 className="ui header inverted">What does it mean if there are no stocks available in the exchange?</h3>
                            ...
                            <h3 className="ui header inverted">Help! I don’t know what Market, Limit and Stoploss orders are!</h3>
                            ...
                            <h3 className="ui header inverted">What exactly is this <em>trade price</em> and how is it determined?</h3>
                            ...
                            <h3 className="ui header inverted">Can I expect any new companies to pop up over the course of the game?</h3>
