                ...
                <div id="help-container" className="ui stackable grid pusher main-container">
                    ...
                    <div className="row">
                        ...
                        <div id="help-content" className="fourteen wide column">
                            ...
                            <div className="ui bottom attached tab segment" data-tab="faqs">
                                <div className="ui styled fluid accordion">
                                    ...
                                    <div className="content">
                                        ...
                                        <p>If you still have any queries, please feel free to ask it on our <a target="_blank" href="https://discord.gg/Qz8QBvgs8H">Official Forum</a> and we'll try to get back to you as soon as possible. Happy Trading!</p>
                                    </div>
                            ...
                            <a href="https://discord.gg/Qz8QBvgs8H" target="_blank">
                                    &nbsp;forum
                            </a>
                            </div>
                        </div>
