            ...
            <div id="help-container" className="ui stackable grid pusher main-container">
                ...
                <div className="row">
                    ...
                    <div id="help-content" className="fourteen wide column">
                        <h2 className="ui header inverted">Welcome to Dalal Street! We know that there’s a lot to take in, so we’ve prepared this help page to get you started and to answer some FAQ as well.</h2>
                        <br />
                        ...
                        <div className="ui bottom attached tab segment" data-tab="faqs">
                            ...
                            <ol start={2}>
                                <li><em>Limit Orders</em>: Limit Orders allow you to specify a <em>maximum</em> trade price in case of a Limit Buy, and a <em>minimum</em> trade price in case of a Limit Sell.</li>
                            </ol>
