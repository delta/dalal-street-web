...
export class SearchBar extends React.Component<SearchBarProps, {}> {
	...
	render() {
		...
		const options = stockDetails.map((stockDetail) => 
			<div key={stockDetail.stockId} className="item" data-value={stockDetail.stockName.toLowerCase()}><i className={stockDetail.stockName.toLowerCase() + " icon"}></i>{stockDetail.stockName}</div>
		);
		return (
