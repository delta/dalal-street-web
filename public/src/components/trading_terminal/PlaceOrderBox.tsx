            ...
            <Fragment>
                ...
                <div className="ui tab inverted " data-tab="market">
                    ...
                    <div className="ui bottom attached active tab segment inverted" data-tab="market/buy">
                        ...
                        <button disabled={this.props.disablePanel ? true : false} className="ui inverted green button" onClick={e => this.handleOrder(e,  MARKET, "buy")}>BUY</button>
                    ...
                    <div className="ui bottom attached tab segment inverted" data-tab="market/sell">
                        ...
                        <button disabled={this.props.disablePanel ? true : false} className="ui inverted red button" onClick={e => this.handleOrder(e, MARKET,"sell")}>SELL</button>
                ...
                <div className="ui tab inverted active" data-tab="limit">
                    ...
                    <div className="ui bottom attached tab segment active inverted" data-tab="limit/buy">
                        ...
                        <button disabled={this.props.disablePanel ? true : false} className="ui inverted green button" onClick={e => this.handleOrder(e, LIMIT,"buy")}>BUY</button>
                    ...
                    <div className="ui bottom attached tab segment inverted" data-tab="limit/sell">
                       ...
                       <button disabled={this.props.disablePanel ? true : false} className="ui inverted red button" onClick={e => this.handleOrder(e, LIMIT,"sell")}>SELL</button>
                ...
                <div className="ui tab inverted" data-tab="stoploss">
                    ...
                    <div className="ui bottom attached tab segment active inverted" data-tab="stoploss/buy">
                        ...
                        <button disabled={this.props.disablePanel ? true : false} className="ui inverted green button" onClick={e => this.handleOrder(e, STOPLOSS,"buy")}>BUY</button>
                    ...
                    <div className="ui bottom attached tab segment inverted" data-tab="stoploss/sell">
                        ...
                        <button disabled={this.props.disablePanel ? true : false} className="ui inverted red button" onClick={e => this.handleOrder(e, STOPLOSS,"sell")}>SELL</button>
